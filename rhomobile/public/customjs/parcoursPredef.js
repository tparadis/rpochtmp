$(document).ready(function(e){
	...
	while(i < data.size)
	{
		...
		$('ul').append('<li><a href="/app/ParcoursPredef/requette_description?type_parcours='+data.parcourspredefs[i].name+'" ><img src="http://rpoch.istic.univ-rennes1.fr/static/images/'+data.parcourspredefs[i].image+'" alt="image" /></a><a href="/app/ParcoursPredef/requette_description?type_parcours='+data.parcourspredefs[i].name+'" ><span class="lien">'+txt+'</span></li>');
